...
class STrack(BaseTrack):
    ...
    def update(self, new_track, frame_id):
        ...
        self.cls = new_track.cls
        self.angle = new_track.angle
        self.idx: torch.Tensor = new_track.idx
...
class BYTETracker:
    ...
    def update(
        ...
        # Add index
        bboxes = torch.cat([bboxes, torch.arange(len(bboxes)).reshape(-1, 1)], axis=-1)
        cls = results.cls
        ...
        return [x.idx.int().item() for x in self.tracked_stracks if x.is_activated]
